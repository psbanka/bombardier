...
if __name__ == "__main__":
    ...
    #for outputName in (set(outputNames).union(set(uhrPlusOutput))):
        #if outputName in outputNames and outputName in uhrPlusOutput:
            #print "%s: MATCH" % outputName
        #elif outputName in outputNames:
            #print "%s (RETURNED ONLY)" % outputName
        #else:
            #print "%s (EXPECTED ONLY)" % outputName
