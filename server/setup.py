...
setup (name = "bombardier_server",
       ...
       packages = ["bombardier_server", "bombardier_server.web", 
                   "bombardier_server.web.rest_api", "bombardier_server.web.rest_api.configs",
                   "django_restapi", "bombardier_server.cnm"],
       package_data = {"bombardier_server": ["web/rest_api/templates/*.html",
                                             "web/rest_api/templates/registration/*.html"]},
       package_dir = {"bombardier_server": "lib", "django_restapi": "lib/django_restapi"},
       data_files = [("web/rest_api/templates", glob.glob("web/rest_api/templates/*.html")),
                     ("web/rest_api/templates/registration", glob.glob("web/rest_api/templates/registration/*.html"))],
       author = "Peter Banka and Shawn Sherwood",
       author_email = "peter.banka@gmail.com",
       long_description = LONG_DESCRIPTION,
       scripts = ["scripts/bdr_server_quickstart", "scripts/bombardier_cnm"],
