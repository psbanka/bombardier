...
class Windows:
    ...
    ### TESTED
    def serviceStatus(self, logger, serviceName):
        hscm          = self.OpenSCManager()
    ...
    def restartService(self, serviceName, logger=None):
    ...
    ### TESTED
    def stopService(self, serviceName, logger=None):
        serviceHandle = self.OpenService(serviceName)
        if self.serviceStatus(logger, serviceName) == OK:
