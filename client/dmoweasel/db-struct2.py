...
if __name__ == '__main__':
    ...
    server = SQLDMOServer.SQLDMOServer(serverName, config['user'], config['password'])
    status = dbprocess2.process_structure(config, server, databaseName, logger, serverName)
    sys.exit( status )
